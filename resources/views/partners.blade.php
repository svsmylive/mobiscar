                    ...
                    >
                        ...
                        <div>
                            ...
                            <h3 class="text-[30px] mb-[10px] text-left lg:text-center lg:text-[24px] lg:mt-[27px]">
                                услуги:</h3>
                            <div
                                class="flex gap-[10px] mb-[19px] lg:justify-center lg:mt-[20px] lg:items-stretch lg:mb-0">
                            ...
                            <div class="flex items-center lg:mt-[18px] xl:flex-col">
                                <div class="flex gap-[11px] lg:flex-col relative xl:w-full">
                                    <a href="#"
                                       class="requestBtn button w-[268px] pt-[23px] pb-[20px] lg:w-auto lg:py-[20px] lg:mx-[22px]"
                                    >ЗАКАЗАТЬ ОБРАТНЫЙ ЗВОНОК</a
                                    >
                                    <a href="{{ $partner->whatsapp_link ?? "#" }}" target="_blank"
                                       class="button-secondary w-[268px] pt-[23px] pb-[20px] lg:w-auto lg:mx-[22px]"
                                    >НАПИСАТЬ В whatsapp
                                    </a>
                                </div>
                                <a href="{{ $partner->reviews_link ?? "#" }}" target="_blank">
